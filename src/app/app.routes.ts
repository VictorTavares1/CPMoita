...
export const routes: Routes = [
  ...
  // Admin protected routes — todos lazy (não carregados para utilizadores públicos)
  {
    ...
    children: [
      ...
      { path: 'orgaos-sociais',           loadComponent: () => import('./pages/admin/orgaos-sociais/orgaos-sociais-list').then(m => m.AdminOrgaosSociais) },
      { path: 'orgaos-sociais/add',       loadComponent: () => import('./pages/admin/orgaos-sociais/orgaos-sociais-add').then(m => m.AdminOrgaosSociaisAdd) },
      { path: 'orgaos-sociais/edit/:id',  loadComponent: () => import('./pages/admin/orgaos-sociais/orgaos-sociais-edit').then(m => m.AdminOrgaosSociaisEdit) },
      { path: 'horarios',                 loadComponent: () => import('./pages/admin/horarios/horarios-list').then(m => m.AdminHorarios) },
      { path: 'horarios/add',             loadComponent: () => import('./pages/admin/horarios/horarios-add').then(m => m.AdminHorariosAdd) },
      { path: 'horarios/edit/:id',        loadComponent: () => import('./pages/admin/horarios/horarios-edit').then(m => m.AdminHorariosEdit) },
      { path: 'logs',                loadComponent: () => import('./pages/admin/logs/logs-list').then(m => m.AdminLogs) },
      { path: 'perfil',              loadComponent: () => import('./pages/admin/perfil/perfil').then(m => m.AdminPerfil) },
